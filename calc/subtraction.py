...
#this is called a namespace it is like files
# and folders the classes are files and the folders organize the classes
...
class Subtraction(Calculation):
    ...
    def get_result(self):
        """Subtracting numbers"""
        #you need to use self to reference the data
        # contained in the instance of the object.  This is encapsulation
